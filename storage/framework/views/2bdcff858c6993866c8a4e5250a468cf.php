    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-muted mb-4">Лабораторная работа №6 - REST API с OAuth2 аутентификацией</p>
            </div>
        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="card required-field">
                    <div class="card-header bg-dark text-white">
                        <h5 class="mb-0">OAuth2 Client Credentials (Обязательные)</h5>
                    </div>
                    <div class="card-body">
...
PASSPORT_CLIENT_SECRET=<?php echo e($personalClient->secret); ?>
                        ...
                        <?php else: ?>
                            <div class="alert alert-danger">
                                <h6>Внимание: OAuth2 Client Credentials не найдены!</h6>
                                <p>Passport требует специальных клиентов. Создайте их:</p>
                                ...
                                <p class="mt-3 mb-0 small text-muted">
                                    После создания клиентов вы сможете создавать токены для доступа к API.
                                </p>
                            </div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="text-center text-muted">
                    <small>Лабораторная работа №6 - REST API с OAuth2 аутентификацией | 
                           Client ID: <?php echo e($personalClient ? $personalClient->id : 'Не установлен'); ?>
    ...
    <script>
        ...
        function showExampleRequest() {
            ...
            const example = `// Пример получения Access Token через Password Grant
...
</html><?php /**PATH C:\Users\User\Desktop\lab33 (2)\resources\views/profile/edit.blade.php ENDPATH**/ ?>